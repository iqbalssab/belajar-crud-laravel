        ...
        @foreach ($posts as $post)
          <tr>
            ...
            <td>
              ...
              <a href="#" class="badge bg-warning text-light fw-bold"><span class="" data-feather="edit"></span></a>
              <a href="#" class="badge bg-danger text-light fw-bold"><span class="" data-feather="trash-2"></span></a>
            </td>
          </tr>
        @endforeach
      </tbody>
